...
function myFunction5() {
    ...
    if (bookButton1.style.backgroundImage.match("facebook.jpg")) {
        bookButton1.style.backgroundImage = "url(https://images-na.ssl-images-amazon.com/images/I/A1agLFsWkOL.jpg)";
        bookButton1.style.backgroundSize = "contain";
        bookButton1.style.backgroundPosition = "center top";
    } else {
        bookButton1.style.backgroundImage = "url(https://assets.teenvogue.com/photos/596e81a07d3e1e55d6876f96/16:9/w_1280,c_limit/facebook.jpg)";
        bookButton1.style.backgroundSize = "contain";
...
function myFunction6() {
    ...
    if (bookButton1.style.backgroundImage.match("fifth-season-limited-cover.jpg")) {
        bookButton1.style.backgroundImage = "url(https://nkjemisin.com/wp-content/uploads/2013/09/Jemisin_FifthSeason-TP.jpg)";
        bookButton1.style.backgroundSize = "cover";
        bookButton1.style.backgroundPosition = "center top";
    } else {
        bookButton1.style.backgroundImage = "url(https://i1.wp.com/www.tor.com/wp-content/uploads/2017/04/fifth-season-limited-cover.jpg?fit=537%2C%209999&crop=0%2C0%2C100%2C810px)";
        bookButton1.style.backgroundSize = "cover";
